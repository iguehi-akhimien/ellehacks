...
const frmatresp = `A senior is asking: ${prompt}. Only show direct steps. Start each step with the word Step. Each step should not be more than 20 words. Then ask me if I understand`;
